...
export const STUDY_CATEGORY = [
    { id: 1, label: "HTML", category: "html", icon: <CodeXml />},
    { id: 2, label: "CSS", category: "css", icon: <CodeXml />},
    { id: 3, label: "JS", category: "js", icon: <CodeXml />},
    { id: 4, label: "REACT", category: "react", icon: <CodeXml />},
]
